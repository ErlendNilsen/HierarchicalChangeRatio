...
setwd("M:/My Documents/Prosjekter/Arbeidsbord/Villrein/Integrated Population Models/Models in PlosOne/PlosOneAppendixes")

library(tidyverse)

load("ModelOutput_real.Rdata")
...
## READING THE SHAPE-FILES FROM THIS FOLDER;
## Using the package maptools

VR1 <- readShapeSpatial("M:/My Documents/Prosjekter/Arbeidsbord/Villrein/Enkle kart/Villreinomrader i Norge.shp")
F1 <-  readShapeSpatial("M:/My Documents/Prosjekter/Arbeidsbord/Villrein/Enkle kart/fylker.shp")

tiff(filename="M:/My Documents/Prosjekter/paper/Rein/Integrated population model/New angle/For submission/Fig1.tiff",
     height=4, width=4, units="in", res=400, compression = "lzw")

par(mfrow=c(1,1), bg="white")
plot(F1, xlim=c(-40000, 400000), ylim=c(6480325, 7003010), border="black", col="grey99")

temp1 <- grep("Snøhettaområdet", as.character(VR1$Omradenavn))
temp2 <- grep("Knutshø", as.character(VR1$Omradenavn))
VR1_sno <- VR1[temp1,]
VR1_knu <- VR1[temp2,]
plot(VR1_sno, col="tomato4", add=T)
plot(VR1_knu, col="yellow4", add=T)
...
tiff(filename="M:/My Documents/Prosjekter/paper/Rein/Integrated population model/New angle/For submission/Fig2.tiff",
     height=4, width=4, units="in", res=400, compression = "lzw")
...
tiff(filename="M:/My Documents/Prosjekter/paper/Rein/Integrated population model/New angle/For submission/Fig3.tiff",
     height=6, width=5, units="in", res=400, compression = "lzw")
...
tiff(filename="M:/My Documents/Prosjekter/paper/Rein/Integrated population model/New angle/For submission/Fig4.tiff",
     height=7, width=7.5, units="in", res=400, compression = "lzw")
...
tiff(filename="M:/My Documents/Prosjekter/paper/Rein/Integrated population model/New angle/For submission/Fig5.tiff",
     height=7, width=7.5, units="in", res=400, compression = "lzw")
...
mtext("SNØHETTA", outer=F, adj=0.01, line=1)
...
mtext("KNUTSHØ", outer=F, adj=0.01, line=1)
...
tiff(filename="M:/My Documents/Prosjekter/paper/Rein/Integrated population model/New angle/For submission/Fig6.tiff",
     height=5, width=5, units="in", res=400, compression = "lzw")
...
legend(seg.len=4, "bottomleft", c("Snøhetta_M1", "Snøhetta_M2", "Knutshø_M1", "Knutshø_M2"), col=c("dark red", "dark blue", "orange2", "grey10" ), lty=1, pch=16,  bty="n", cex=0.8)
